...
namespace BCVlxd
{
    public partial class QLSanpham : Form
    {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (list.Contains(txtMaVT.Text.ToString()))
                    {
                        ...
                        pd.capNhat("INSERT INTO Chitietkhohang(Makho,Mavattu,soluong) values(N'" + cmbMakho.Text.ToString() + "',N'" 
                            + txtMaVT.Text.ToString() + "','0')");
                        MessageBox.Show("Bạn đã thêm thành công");
                        dataGridView1.DataSource = pd.docbang("select c.Makho,v.Mavattu,v.Tenvattu,c.soluong,v.Madonvitinh,v.MaNCC,v.Gianhap,v.Giaxuat "+
                            "from Vattu as v join Chitietkhohang as c on v.Mavattu = c.Mavattu join Khohang as k on k.Makho = c.Makho");

                    }
                    else
                    {
                        pd.capNhat("INSERT INTO Vattu (Mavattu,Tenvattu,Madonvitinh,MaNCC) "
                            + " values( N'" + txtMaVT.Text.ToString() + "', N'" + txtTenVT.Text.ToString() + "',N'" + cmbMaDVT.Text + "', N'" 
                            + cmbMaNCC.Text + "')");
                        pd.capNhat("INSERT INTO Chitietkhohang(Makho,Mavattu,soluong) values(N'" + cmbMakho.Text.ToString() + "',N'" 
                            + txtMaVT.Text.ToString() + "','0')");
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            {
                string sql16 = "Update Chitietkhohang set soluong = '0' " +
                                 "FROM Vattu v " +
                ...
                dataGridView1.DataSource = pd.docbang("select c.Makho,v.Mavattu,v.Tenvattu,c.soluong,v.Madonvitinh,v.MaNCC,v.Gianhap," +
                    "v.Giaxuat from Vattu as v join Chitietkhohang as c on v.Mavattu = c.Mavattu join Khohang as k on k.Makho = c.Makho");
