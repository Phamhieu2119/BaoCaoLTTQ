...
namespace BCVlxd
{
    public partial class QLKhohang : UserControl
    {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            {
                DataTable dtnhanven = pd.docbang("Select Makho,Tenkho,MaNV,Dienthoai,Dientich from Khohang where" 
                    + " Makho =N'" + txtMaKho.Text + "'");
                ...
                {
                    pd.capNhat("insert into Khohang(Makho,Tenkho,MaNV,Dienthoai,Dientich) values(N'" + txtMaKho.Text + "',N'" 
                        + txtTenkho.Text + "',N'" + (cmbMaNV.Text).Trim() + "',N'" + txtDienThoai.Text + "',N'" + txtDientich.Text + "')");
