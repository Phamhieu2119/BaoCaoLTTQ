    ...
    public partial class ChitietXuatkho : Form
    {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    pd.ketnoi();
                    string sql4 = "select count(*) from Vattu as v join Chitietkhohang as c on v.Mavattu = c.Mavattu join Khohang as k " +
                        "on k.Makho = c.Makho where c.MaVattu = N'" + cmbMaVT.Text + "'and c.Makho = N'" + cmbMakho.Text + "'";
                    ...
                    {
                        pd.ketnoi();
                        string sql10 = "select sum(soluong) from Vattu as v join Chitietkhohang as c on v.Mavattu = c.Mavattu join Khohang " +
                            "as k on k.Makho = c.Makho where c.MaVattu = N'" + cmbMaVT.Text + "'and c.Makho = N'" + cmbMakho.Text + "'";
                    ...
                    pd.ketnoi();
                    string query = "select *  from Quanlysanphamkho where Ngaynhap < (select Ngayxuat from Xuatkho  where Mahoadon = N'" + 
                        cmbMaHD.Text + "'  ) and Makho = N'" + cmbMakho.Text + "' and Mavattu = N'" + cmbMaVT.Text + "' " +
                        "order by Makho asc , Mavattu asc , Ngaynhap asc";
                    SqlDataAdapter adapter = new SqlDataAdapter(query, pd.Con);
                    DataTable dataTable = new DataTable();
                    adapter.Fill(dataTable);
                    ...
                    pd.capNhat("update c set c.thanhtien = c.soluong * " + giaBan + " from Chitietxuatkho as c join Xuatkho as x " +
                        "on c.Mahoadon = x.Mahoadon where c.Mahoadon = N'" + cmbMaHD.Text + "' and x.Makho = N'" + cmbMakho.Text+
                        "' and c.Mavattu = N'"+cmbMaVT.Text+"'");
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            if (check())
            {
                ...
                if (MessageBox.Show("Bạn có muốn sửa hóa đơn này không ?", "Warning", MessageBoxButtons.YesNo) == DialogResult.Yes)
                {
                    ...
                    else if (valuesold < int.Parse(txtSoluong.Text.ToString()))
                    {
                        pd.ketnoi();
                        string sql20 = "select sum(c.soluong) from Chitietkhohang as c join Khohang as k on c.Makho = k.Makho join Vattu as v " +
                            "on v.Mavattu = c.Mavattu where c.MaVattu = N'" + cmbMaVT.Text + "'and k.Makho = N'" + cmbMakho.Text + "'";
        ...
        private void btnDulieu_Click(object sender, EventArgs e)
        {
            //tinhtien();
            pd.ketnoi();
            string query1 = "select  Mavattu from Chitietxuatkho  where Mahoadon = N'"+cmbMaHD.Text+"'";
            SqlCommand cmd1 = new SqlCommand(query1, pd.Con);
            ...
            foreach (string material in list)
            {
                ...
                pd.ketnoi();
                string query = "select *  from Quanlysanphamkho where Ngaynhap < (select Ngayxuat from Xuatkho  where Mahoadon = N'" + cmbMaHD.Text + "') and Makho = N'" + cmbMakho.Text + "' and Mavattu = N'" + material + "' order by Makho asc , Mavattu asc , Ngaynhap asc";
                SqlDataAdapter adapter = new SqlDataAdapter(query, pd.Con);
                DataTable dataTable = new DataTable();
                adapter.Fill(dataTable);
                // Tìm đến hàng cuối cùng của bảng
                ...
                pd.capNhat("update c set c.thanhtien = c.soluong * " + giaBan + " from Chitietxuatkho as c join Xuatkho as x on c.Mahoadon = x.Mahoadon where c.Mahoadon = N'" + cmbMaHD.Text + "' and x.Makho = N'" + cmbMakho.Text + "' and c.Mavattu = N'" + material + "'");
