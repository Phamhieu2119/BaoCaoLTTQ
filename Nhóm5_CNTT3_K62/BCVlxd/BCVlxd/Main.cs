...
namespace BCVlxd
{
    public partial class Main : Form
    {
        ...
        {
            name.Text = "Quản lý sản phẩm";
            // Hiển thị Form3
            //chitietXuatkho.ShowDialog();
            btnDoanhthu.FillColor = Color.Pink; // Màu khi được chọn
            btnDoanhthu.ForeColor = Color.White;
            quanlysanpham = new Quanlysanpham(this);
            quanlysanpham.TopLevel = false;
            quanlysanpham.FormBorderStyle = FormBorderStyle.None;
            quanlysanpham.Dock = DockStyle.Fill;
            MainPanel.Controls.Add(quanlysanpham);
            MainPanel.Tag = chitietXuatkho;
